      ...
      <DialogContent className="sm:max-w-md bg-white dark:bg-gray-900 border-slate-200 dark:border-gray-700">
        ...
        <div className="space-y-3 mb-6">
          ...
          <button
            ...
            disabled={connecting}
            className="w-full flex items-center gap-4 px-5 py-3.5 rounded-xl bg-slate-50 dark:bg-gray-800 border border-slate-200 dark:border-gray-700 hover:border-purple-400 dark:hover:border-purple-500/50 hover:bg-purple-50 dark:hover:bg-gray-800/80 transition-all group disabled:opacity-50 disabled:cursor-wait"
          >
            ...
            {connecting ? (
              ...
              <div className="text-slate-300 dark:text-gray-600 group-hover:text-purple-500 dark:group-hover:text-purple-400 transition-colors text-sm">
                &rarr;
              </div>
            )}
          </button>
