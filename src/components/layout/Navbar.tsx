          ...
          <div className="flex items-center justify-between h-16">
            ...
            <Link href="/" className="flex items-center gap-2 group">
              ...
              <span className="text-slate-900 dark:text-white font-bold text-lg hidden sm:block">
                Sol<span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-cyan-500 dark:from-purple-400 dark:to-cyan-400">Forge</span>
              </span>
            </Link>
            ...
            <div className="flex items-center gap-2">
                      ...
                      {langs.map(l => (
                        <button
                          ...
                          className={`w-full px-4 py-2 text-left text-sm flex items-center gap-2 hover:bg-slate-50 dark:hover:bg-gray-800 transition-colors ${
                            lang === l.code ? 'text-purple-600 dark:text-purple-400' : 'text-slate-700 dark:text-gray-300'
                          }`}
                        >
                          <span>{l.flag}</span>
                          <span>{l.label}</span>
              ...
              {isAuthenticated ? (
                ...
                <button
                  ...
                  className="px-4 py-2 rounded-lg bg-gradient-to-r from-purple-600 to-cyan-600 text-white text-sm font-semibold hover:from-purple-500 hover:to-cyan-500 transition-all shadow-lg shadow-purple-500/20"
                >
                  {t('nav.login')}
                </button>
              )}
