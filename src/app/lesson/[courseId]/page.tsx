        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <div className="relative bg-white dark:bg-gray-900 border border-slate-200 dark:border-gray-700 rounded-2xl p-8 w-full max-w-md text-center shadow-2xl">
            ...
            <div className="my-6 p-4 rounded-xl bg-gradient-to-br from-purple-50 to-cyan-50 dark:from-purple-900/40 dark:to-cyan-900/40 border border-purple-200 dark:border-purple-500/30">
              ...
              <p className="text-purple-700 dark:text-cyan-300 font-semibold text-sm">
                {t("lesson.certMinted")}
              </p>
          ...
          <div className="p-6">
            ...
            <div className="mb-4">
              <div className="flex items-center gap-2 mb-3">
                ...
                />
                <h4 className="text-cyan-700 dark:text-cyan-400 font-semibold text-sm">
                  {t("lesson.instructions")}
                </h4>
              </div>
              <div className="prose prose-sm prose-slate dark:prose-invert max-w-none [&_code]:px-1.5 [&_code]:py-0.5 [&_code]:rounded [&_code]:bg-slate-100 [&_code]:dark:bg-gray-800 [&_code]:text-purple-600 [&_code]:dark:text-purple-400 [&_code]:text-xs [&_code]:font-mono [&_p]:text-sm [&_p]:leading-relaxed [&_p]:text-slate-600 [&_p]:dark:text-gray-300 [&_strong]:text-slate-900 [&_strong]:dark:text-white [&_li]:text-sm [&_li]:text-slate-600 [&_li]:dark:text-gray-300">
