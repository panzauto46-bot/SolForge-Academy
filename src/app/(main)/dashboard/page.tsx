                  ...
                  {enrolledCourseData.map(course => {
                    ...
                    return (
                      <button
                        ...
                        className="w-full flex items-center gap-4 p-4 rounded-xl bg-slate-50 dark:bg-gray-800/50 border border-slate-200 dark:border-gray-700/50 hover:border-purple-300 dark:hover:border-purple-500/30 transition-all group"
                      >
                        ...
                        <ChevronRight size={16} className="text-slate-300 dark:text-gray-600 group-hover:text-purple-500 dark:group-hover:text-purple-400 transition-colors" />
                      </button>
                    );
                  })}
                </div>
              ...
              {user.nftCertificates.length === 0 && blockchainCerts.length === 0 ? (
                ...
                <div className="space-y-3">
                  {user.nftCertificates.map((cert, i) => {
                    ...
                    return (
                      <div key={i} className="p-3 rounded-xl bg-gradient-to-br from-purple-50 to-cyan-50 dark:from-purple-900/30 dark:to-cyan-900/30 border border-purple-200 dark:border-purple-500/20">
                        <div className="flex items-center gap-3">
