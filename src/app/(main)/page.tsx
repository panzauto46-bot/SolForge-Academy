    ...
    <>
      ...
      <section className="bg-slate-50 dark:bg-gray-950 py-20 transition-colors">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-3">Why SolForge Academy?</h2>
      ...
      <section className="bg-slate-50 dark:bg-gray-950 pb-20 transition-colors">
        <div className="max-w-3xl mx-auto px-4 text-center">
          <div className="p-10 rounded-3xl bg-gradient-to-br from-purple-50 to-cyan-50 dark:from-purple-900/30 dark:to-cyan-900/30 border border-purple-200 dark:border-purple-500/20 shadow-lg dark:shadow-none">
            ...
            <button
              ...
              className="px-8 py-4 rounded-2xl bg-gradient-to-r from-purple-600 to-cyan-600 text-white font-bold text-lg shadow-2xl shadow-purple-500/25 hover:shadow-purple-500/40 transition-all hover:scale-105"
            >
