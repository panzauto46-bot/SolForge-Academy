...
> Technical architecture documentation for **SolForge Academy** -- a gamified Solana learning platform built with Next.js 16 and TypeScript.
...
SolForge uses a **unified authentication model** supporting both Web3 wallets and traditional OAuth:
...
3. Filters for SolForge Academy NFTs
